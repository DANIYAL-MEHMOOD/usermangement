...
(@SettingsId, 'Theme', 'bi-palette', 'Theme', '/settings/theme', 2, 1);
GO
...
/* Default admin user — password is 'ChangeMe123!' hashed with PBKDF2 at app layer.
   Placeholder hash/salt below MUST be replaced by running the app's user seeding
   routine (see MyApp.Infrastructure/Security/PasswordHasher.cs) before go-live. */
...
VALUES
    ('EMP-0001', 'admin', 0x00, 0x00, 'System Administrator', 'admin@myapp.local', @AdminRoleId, 1, DATEADD(DAY, 90, SYSUTCDATETIME()));
GO
